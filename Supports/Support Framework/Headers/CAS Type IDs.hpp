...
#define CUSTOM_AMMO_TYPE(ATTACK_TYPE_ID,AMMO_CLASS) {ATTACK_TYPE_ID,AMMO_CLASS}
#define CUSTOM_AMMO_TYPE_W_NAME(ATTACK_TYPE_ID,AMMO_CLASS,MENU_NAME) {ATTACK_TYPE_ID,AMMO_CLASS,MENU_NAME}
