/* ----------------------------------------------------------------------------
Function: KISKA_fnc_CBA_randPosArea

Description:
    Copied version of the CBA function `CBA_fnc_randPosArea`.
...
Parameters:
    0: _area <MARKER, TRIGGER, LOCATION, ARRAY> - The area to find a position within.
    1: _perimeter <BOOL> Default: `false` - `true` to return only positions on the area perimeter.

Returns:
    <ARRAY> - The position or empty array if invalid area was provided.
...
---------------------------------------------------------------------------- */
scriptName "KISKA_fnc_CBA_randPosArea";
