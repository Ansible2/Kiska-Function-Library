...
#define ON_STATE_ENTERED(NAME,EVENT) onStateEntered = "[_this,"#EVENT",[_this,"#NAME",configFile >> 'KISKA_eventHandlers' >> 'CombatBehaviour'],false] call BIS_fnc_callScriptedEventHandler";
